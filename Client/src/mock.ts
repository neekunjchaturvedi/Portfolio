...
export const mockData = {
  ...
  skills: {
    frontend: [
      ...
      { name: "ReactJS", icon: "Component", level: 5 },
    ...
    backend: [
      ...
      { name: "Express.js", icon: "Route", level: 5 },
  ...
  projects: [
    ...
    },
    {
      ...
      githubUrl: "https://github.com/neekunjchaturvedi/top-code",
