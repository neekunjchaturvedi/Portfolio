          ...
          <div className="space-y-8">
            {data.map((item) => (
              <div key={item.id} className="relative group">
                {/* Timeline Dot */}
                <div className="absolute left-6 top-8 w-4 h-4 bg-slate-800 rounded-full border-4 border-white shadow-lg hidden md:block group-hover:bg-green-600 transition-colors duration-200"></div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      <div className="p-3 bg-slate-100 rounded-lg group-hover:bg-slate-800 transition-colors duration-200">
                        <GraduationCap className="h-6 w-6 text-slate-600 group-hover:text-white transition-colors duration-200" />
                      </div>
